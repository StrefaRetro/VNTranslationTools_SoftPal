...
// Downscale shader (lanczos2 with antiring)
static const char* g_DownscaleHLSL = R"HLSL(
...
// CuNNy upscale shader
static const char* g_CuNNyFastNVL =
...
// Bicubic interpolation shader
    static const char* g_BicubicShader = R"(
